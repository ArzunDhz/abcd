                    ...
                    {data.map(items =>
                        <>
                            <div className="flex justify-between items-center">
                                <div role="status" class=" h-80 m-auto mt-20 max-w-sm lg:max-w-xl p-4  md:p-6 bg-[#131B21] rounded-lg  bg-opacity-50">
                                    <img className=' h-48 ml-[24px] ' src={items.snippet.thumbnails.high.url} alt="" />
