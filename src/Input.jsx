...
const Input = () => {
  ...
  const downloadmp3 = async (e) => {
    ...
    return await axios.request(options).then((response) => { window.location.replace(response.data.link), setLoading(false) })
  ...
  const downloadmp4 = async (e) => {
    ...
    return await axios.request(options).then((response) => { window.location.replace(response.data.video.url), setLoading(false) })
  }
